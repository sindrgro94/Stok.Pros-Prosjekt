...
simN2 = task3bd(days);%number of claims simulated with lambda=2+cos(t*pi/182.5)
simTotClaims1 = sum(exp(normrnd(mu,sigma,1,simN1)));%total claims with lambda1
simTotClaims2 = sum(exp(normrnd(mu,sigma,1,round(simN2))));%total claims with lambda2
